!function (e, t) {
  ...
  return function (e) {
    ...
    function c(e, t, i) {
      var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : b, n = "", r = void 0;
      ...
      if (document.all || f) {
        try {
          if (e = new ActiveXObject("ShockwaveFlash.ShockwaveFlash")) {
            return t.FLASH_VERSION = A = e.GetVariable("$version").split(" ")[1].replace(/,/g, "."), window.console && console.log("FLASH_VERSION", A), !0
          }
        } catch (i) {
          return !1
        }
    ...
    t.Player = function () {
      ...
      return e.prototype.render = function (e) {
        ...
        if (!this.video) {
          return x.console.error("create video failed")
        }
        ...
        return C.IE_VERSION && x.compareVersion(C.IE_VERSION, "8.0") == -1 ? (this.errortips.show({code: 5}), !1) : !!this.options.src || (this.options.videoSource.hasUrl() ? C.IS_IE || !C.IS_ENABLED_FLASH ? this.errortips.show({code: 5}) : this.errortips.show({code: 5}) : this.errortips.show({code: 12}), !1)
        ...
        switch (e.type) {
          ...
          case O.Error:
            ...
            try {
              ...
              C.IS_X5TBS ? MtaH5.clickStat("x5_err", {format: o}) : MtaH5.clickStat("error", {format: o})
            } catch (n) {
            }
        }
    ...
    function r(e, t) {
      var i = A(), o = g[g.length - 1];
      if ("top" === e.insertAt) {
        o ? o.nextSibling ? i.insertBefore(t, o.nextSibling) : i.appendChild(t) : i.insertBefore(t, i.firstChild), g.push(t)
      } else {
    ...
    function c(e, t) {
      ...
      if (t.singleton) {
        ...
        e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = l(t), o = h.bind(null, i), n = function () {
    ...
    t.__esModule = !0;
    var l = i(24), c = n(l), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = (o(h), i(25)), f = (o(d), function (e) {
      function t(i) {
    ...
    t.__esModule = !0;
    var l = i(24), c = n(l), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = o(h), f = function (e) {
      function t(i) {
    ...
    t.__esModule = !0;
    var l = i(30), c = n(l), u = i(24), p = n(u), h = i(2), d = (o(h), i(3)), f = o(d), y = function (e) {
      function t(i) {
      ...
      return a(t, e), t.prototype.render = function (t) {
        ...
        if (this.enabled) {
          return "undefined" == typeof e ? this.progress.percent() || 0 : (e = Math.min(e, 1), this.syncLabel(e), this.__buffered < e && this.buffered(this.player.buffered()), this.progress.percent(e))
        }
      }, t
    }(p["default"]);
    t["default"] = y
    ...
    t.__esModule = !0;
    var l = i(30), c = (n(l), i(24)), u = n(c), p = i(2), h = (o(p), i(3)), d = o(h), f = function (e) {
      function t(i) {
    ...
    t.__esModule = !0;
    var l = i(30), c = n(l), u = i(24), p = n(u), h = i(2), d = o(h), f = i(3), y = o(f), A = i(4), v = function (e) {
      function t(i) {
    ...
    t.__esModule = !0;
    var l = i(24), c = n(l), u = i(1), p = o(u), h = function (e) {
      function t(i) {
      ...
      return a(t, e), t.prototype.render = function (t) {
        ...
        switch (e.type) {
          ...
          case v.MSG.MetaLoaded:
            if (this.__loaded = !0, !this.player.playing()) {
              break
            }
            this.hide();
          case v.MSG.Play:
    ...
    t.__esModule = !0;
    var l = i(24), c = n(l), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = (o(h), function (e) {
      function t(i) {
        r(this, t);
    ...
    t.__esModule = !0;
    var l = i(24), c = n(l), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = o(h), f = {
